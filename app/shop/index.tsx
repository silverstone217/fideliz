      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            clearData();
            setShop(null);
            setFirstTime(true); // reset firstTime to true to show the welcome screen again.
            setClients([]);
          ...
          <View style={styles.actionsMain}>
            ...
            <View style={styles.conversions}>
              ...
              >
                ...
                >
                  <TouchableOpacity onPress={() => router.navigate("/modal")}>
            ...
            <View style={styles.actions}>
              ...
              <View style={{ gap: 10 }}>
                ...
                <TouchableOpacity
                  ...
                  disabled={loading}
                  onPress={() => router.navigate("/ModalQrCodeReader")}
                >
