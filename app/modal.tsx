...
import { useAppState, useShopState } from "../lib/store";
...
const ModalScreen = () => {
  ...
  const isButtonDisabled = useMemo(() => {
    ...
    return false;
  }, [name, usd, fcd, pointUsd, pointFcd, shop, loading, isEmptyString]);
        ...
        <View style={styles.container}>
          ...
          <View style={styles.form}>
            ...
            >
              {/* USD fields */}
              <View style={{ flex: 1 }}>
                <Text style={styles.label}>Devise USD*</Text>
                <TextInput
                  defaultValue={usd}
            ...
            >
              {/* FCD fields */}
              <View style={{ flex: 1 }}>
                <Text style={styles.label}>FCD*</Text>
                <TextInput
                  defaultValue={fcd}
